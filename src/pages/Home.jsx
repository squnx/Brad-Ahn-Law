          ...
          <div className="row">
            <div className="col-xl-5">
              ...
              <div className="d-flex" data-aos="fade-up" data-aos-delay="200">
                ...
                <a href="https://youtube.com/shorts/45DH8xrxdaM" className="glightbox btn-watch-video d-flex align-items-center" target="_blank"><i className="bi bi-play-circle"></i><span>Watch Video</span></a>
              </div>
            </div>
          </div>
        </div>
